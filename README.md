...
#### Đọc bản tiếng Anh tại `<kbd><a href="docs/translations/README_en.md">`English`</a></kbd>`
...
| -------------------- | ---------------------------------------------------------- |
| Đội thi            | `Cow` 🐄                                                 |
| Thành viên         | `Minh Le, Uyen Nguyen, Viet Nguyen`                      |
...
chạy trên máy chấm. Trên GPU 16 GB, đặc biệt là các card chậm hơn như T4, thời
gian chạy có thể lâu hơn đáng kể.
...
## Hướng Dẫn Chạy Cho Ban Giám Khảo

### Yêu Cầu

- **NVIDIA CUDA GPU** có ít nhất **16 GB** VRAM
- Ví dụ phù hợp: RTX 3090/4090, RTX 4080 16 GB, RTX A5000/A6000, A100, L4,
  hoặc GPU CUDA tương đương
- T4 16 GB có thể chạy, nhưng nên kỳ vọng inference chậm hơn và biên bộ nhớ
  chặt hơn
- Docker
- NVIDIA Container Toolkit, để `docker run --gpus all` hoạt động
